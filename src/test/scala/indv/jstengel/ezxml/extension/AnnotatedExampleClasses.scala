...
import indv.jstengel.ezxml.extension.ct.{CTConverter, CTLoader, Xml}
...
//                                                        ct2: ClassTag[T2],
//                                                        tt3: TypeTag[T3],
//                                                        ct3: ClassTag[T3]) extends indv.jstengel.ezxml.extension.XmlClassTrait {
//
...
//
//        override def saveAsXml : Elem = CTConverter.xmlMacro[AnnotatedTypeParameterTestClass1[T1, T2, T3]](this)
//    }
