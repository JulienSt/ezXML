...
import indv.jstengel.ezxml.extension.ct.CTConverter.{xml, xmlMacro}
import indv.jstengel.ezxml.core.SimpleWrapper.NodeWrapper
import indv.jstengel.ezxml.extension.AnnotatedExampleClasses._
import indv.jstengel.ezxml.extension.ExampleClasses.{CurriedClass, StrangeIterator}
...
//    new CTSpecialTypeParameterTestClass2("test", 1, 2, 3, 4, 5, 6, 7, 8).xml.toPrettyXMLString
    ...
    println(new CurriedClass(123)("test")(3.141592658).xml)
    println(xml(new CurriedClass(123)("test")(3.141592658)))
